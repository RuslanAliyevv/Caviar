...
export default function AddtoCard({productId, closeMock }) {
  ...
  product && product.variants
    ...
    : [];
    useEffect(() => {
      if (product && product.variants && product.variants.length > 0 && !selectedGram) {
    ...
    useEffect(() => {
      const fetchProduct = async () => {
        try {
          const response = await axios.get(`https://bbcaviar.com/api/v1/products/${productId}`);
              ...
              <div className={`row ${styles.rowAll}`}>
                ...
                <div className="col-lg-1 col-2">
                  <div className={styles.right}>
                    <div className={styles.imgEdit} onClick={() => closeMock(false)}>
                      <Image width={24} height={26} alt="" src="/assets/image/x.png" />
                    </div>
                  </div>
                </div>
            ...
            <div className={`row ${styles.rowAll}`}>
              <div className="col-lg-5">
                <div className="box">
                  <div className={styles.boxDiv}>
                    {product &&
                    product.variants &&
                    product.variants.find((variant) => variant.grams.weight === selectedGram) &&
                    product.variants.find((variant) => variant.grams.weight === selectedGram)
                      .product_attachments &&
                    product.variants.find((variant) => variant.grams.weight === selectedGram)
              ...
              <div style={{ marginLeft: "0px" }} className="col-lg-6">
                <div className={styles.box}>
                  <div style={{ marginTop: "15px" }} className="row align-items-baseline">
                    <div className="col-lg-8">
                      ...
                      <span className={styles.h5CheckOut}>calculated at checkout.</span>
                      <div className={styles.line}></div>
                  ...
                  {sortedVariants &&
                    sortedVariants.map((variant) => (
                      ...
                      <h5 className={styles.buttonHover} onClick={handleAddToCart} style={{ marginTop: "10px" }}>
                        Add to Cart
                      </h5>
                      <h6  onClick={() =>
                          router.push(
                        ...
                        } className={styles.h6About}>More info about product</h6>
                </div>
              </div>
            </div>
          </div>
